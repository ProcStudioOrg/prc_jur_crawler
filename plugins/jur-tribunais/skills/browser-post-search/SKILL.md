...
Complementa a skill `jur/codegen/SKILL.md` (`codegen`), que cobre a **entrada** (filtros,
...
1. **`<NN>-resultados.txt`** na pasta do módulo, seguindo o
   `jur/human-codegen/MODELO-TRIBUNAL.md` §18–§20.
2. **Prints** no padrão do `jur/CLAUDE-CODEGEN.md` §3
